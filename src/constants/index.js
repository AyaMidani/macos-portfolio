...
const WORK_LOCATION = // ▶ Project 1
{
  id: 5,
  name: "AI Mock Interview Platform (PrepWise)",
  ...
  children: [
    {
      ...
      position: "top-5 left-10",
      description: [
        "A high-performance URL Shortener built with Go (Fiber) and Redis, containerized with Docker for easy deployment.",
        "Instead of slow redirects, it uses Redis for near-instant lookups with rate limiting and reverse proxy rewrites for security.",
        "Think of it like a lightweight Bitly clone—fast, secure, and built for scale with a modern React + Vite + TailwindCSS frontend.",
        "Features URL parsing, rate limiting, and a clean interactive UI for creating and managing shortened links.",
      ],
    },
    {
      id: 2,
      name: "url-shortener.com",
      icon: "/images/safari.png",
      kind: "file",
      fileType: "url",
      href: "https://github.com/AyaMidani",
